...
model.add(LSTM(200, return_sequences=True, activation='tanh', input_shape=(None, x_all.shape[2])))
...
#if os.path.isfile('keras-weights42.nn'):
  #print 'Loading Model...'
  #model.load_weights('keras-weights4.nn')
print 'Begin Training...'
for i in xrange(1, days, 2):
...
print 'Saving Model...'
model.save_weights('keras-weights42.nn', overwrite=True)
