...
print 'Testing Model...'
score = model.evaluate(data_test[:, :-1, :], data_test[:, 1:, :4], batch_size=batch_size, verbose=1, show_accuracy=True)
print 'Test Score: ', score

model.fit(data[:, :-1, :], data[:, 1:, 0:4], batch_size=batch_size, nb_epoch=epochs, shuffle=False, validation_data=(data_test[:, :-1, :], data_test[:, 1:, :4]))#, validation_split=0.05)
print 'Saving Model...'
